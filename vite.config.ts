...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      '/auth/login': 'http://localhost:8010',
      '/auth/exchange': 'http://localhost:8010',
      '/auth/refresh': 'http://localhost:8010',
      '/auth/logout': 'http://localhost:8010',
      '/auth/me': 'http://localhost:8010',
      '/auth/dev-token': 'http://localhost:8010',
