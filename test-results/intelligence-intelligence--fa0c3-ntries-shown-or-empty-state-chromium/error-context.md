...
- Name: intelligence\intelligence-hub.spec.ts >> Intelligence Hub >> episodic memory — API entries shown or empty state
- Location: e2e\intelligence\intelligence-hub.spec.ts:81:3
...
Locator: locator('[data-testid="episodic-list"]').or(locator('text=No episodic memory entries yet.')).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="episodic-list"]').or(locator('text=No episodic memory entries yet.')).first()
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e98]:
      ...
      - main [ref=e129]:
        - generic [ref=e130]:
          - img [ref=e131]
          - heading "Something went wrong" [level=2] [ref=e133]
          - paragraph [ref=e134]: a.filter is not a function
          - button "Try Again" [ref=e135]
